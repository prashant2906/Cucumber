@CDTMaintSanity
Feature: Verify CDT Maint all Geo testcases

@TestEmail
Scenario: CDT Maint Test internal IBM GUI flow for AP
...
@CDTMaintSanityNA  
  Scenario: CDT Maint Test internal IBM GUI flow for NA
    Given Open firefox and start application
    When Click on CDT Maint India Lab GUI link
    Then GUI home page should open
...
@CDTMaintSanityEMEA  
  Scenario: CDT Maint Test internal IBM GUI flow for EMEA
    Given Open firefox and start application
    When Click on CDT Maint India Lab GUI link
    Then GUI home page should open
...
@CDTMaintSanityJP  
  Scenario: CDT Maint Test internal IBM GUI flow for Japan
    Given Open firefox and start application
    When Click on CDT Maint India Lab GUI link
    Then GUI home page should open
...
@CDTMaintSanityLA  
  Scenario: CDT Maint Test internal IBM GUI flow for LA
    Given Open firefox and start application
    When Click on CDT Maint India Lab GUI link
    Then GUI home page should open
